...
Component({
  ...
  methods: {
    ...
    _getProductInfo: function _getProductInfo() {
      var url = this._getHost().wmpHost + 'my/selectProduct?userToken=' + this.data._request.userToken + '&sdkProductId=' + this.data._request.sdkProductId;
      wx.request({
        url: url,
        data: {},
        method: 'POST',
        success: function success(res) {
          if (res && res.data && 200 == res.data.status) {
            ...
            if (that.data.productList && 1 == that.data.productList.length) {
              that.setData({
    ...
    _selectProduct: function _selectProduct(e) {
      this.setData({
        selectedPid: e.currentTarget.dataset.pid
      });
    },
    _viewProductRight: function _viewProductRight(e) {
    ...
    _buySelect: function _buySelect() {
