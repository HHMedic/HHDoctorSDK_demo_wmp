...
Component({
  ...
  methods: {
    ...
    _setInputValue: function _setInputValue(e) {
      var sa = this.data.saveAddress;
    ...
    _clearInputValue: function _clearInputValue(e) {
      var sa = this.data.saveAddress;
    ...
    _getAddress: function _getAddress() {
      var url = this._getHost().wmpHost + 'address/detailP?userToken=' + this.data._request.userToken + '&id=' + this.data._request.addressId;
      wx.request({
        url: url,
        data: {},
        method: 'POST',
    ...
    _saveAddress: function _saveAddress() {
