  ...
  methods: {
    ...
    _getUserAcl() {
      var url = this._getHost().wmpHost +
        'wmp/personalAcl?userToken=' + this.data._request.userToken + '&sdkProductId=' + this.data._request.sdkProductId + '&source=wmpSdk';
      wx.request({
        url: url,
        data: {},
        method: 'POST',
    ...
    _getProductInfo() {
      var url = this._getHost().wmpHost +
        'my/product?userToken=' + this.data._request.userToken;
      wx.request({
        url: url,
        data: {},
        method: 'POST',
