  ...
  methods: {
    ...
    bindFilingImg: function (e) {
      ...
      if (this.data.name == 'DICOM') {
        ...
        let url = `https://mp.hh-medic.com/ehrweb/view/?module=fileList&mrid=${this.data.medicRecordId}&patientUuid=${this.data.memberUuid}&userToken=${getApp().globalData._hhSdkOptions._userToken || ''}&type=DICOM%E4%BF%A1%E6%81%AF&appId=${getApp().globalData.appId || ''}`
        this._viewUrl(url)
      }
