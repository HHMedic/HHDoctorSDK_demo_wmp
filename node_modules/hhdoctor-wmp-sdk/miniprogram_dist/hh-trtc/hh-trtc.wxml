...
<view class="page-room">
	<view hidden='{{isEvaluate}}'>
		...
		<!-- 排队中2 -->
		<phase-c style='display:{{phase==phaseStatus.QUEUE?"block":"none"}}' callTips='{{callTips}}' bind:hangUp='bindHangUp' waitTips='{{waitTips}}' ></phase-c>
		<!-- 观看小视频6 -->
	...
	<!-- <view class='hide-tip' wx:if='{{isHideTip&&phase==3}}' catchtap='bindCloseHideTip'>
		请不要离开此界面，以防视频中断 <view class='hide-tip-close' ></view>
	</view> -->
