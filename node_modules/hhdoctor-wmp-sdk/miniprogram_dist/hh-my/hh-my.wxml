    ...
    <view class='info {{primeLevel}}'>
      ...
      <view class='info-list'>
        ...
        <view class='info-line date'>
          <view wx:if="{{productDesc && !_request.userAcl.hideProductDesc}}">{{productDesc}}</view>
...
<!--会员权益-->
<user-equity product='{{product}}' request='{{_request}}' wx:if='{{product&&_request.userAcl.showProductRight}}' base-path='../../'></user-equity>
<view class='panel list' style="margin-bottom:{{bottomHeight}}px;">
  ...
  <view class='menu-group' wx:if='{{_request.sdkProductId==10265&&doctorTeamUrl}}'>
    <view class='menu-item' catchtap='_viewDoctorTeam' >
      <view class='menu-icon doctor'></view>
      <view class='menu-name'>私人医生团队</view>
      <view class='menu-remark'></view>
      <view class='menu-arrow'></view>
    </view>
  </view>

  <view class='menu-group' wx:if='{{_request.sdkProductId==10239}}'>
    <view class='menu-item'  catchtap='_viewShopCoupon'>
      <view class='menu-icon coupon'></view>
      <view class='menu-name'>抵用券</view>
      <view class='menu-remark'></view>
      <view class='menu-arrow'></view>
    </view>
  </view>
  ...
  <view class='menu-group'>
    <view class='menu-item' catchtap='_viewActiveCode' data-msg='{{_request.userAcl.activeCodeMsg}}' wx:if='{{_request.userAcl.showActiveCode}}'>
      ...
      <view class='menu-name'>激活码激活</view>
      <view class='menu-remark'></view>
      <view class='menu-arrow'></view>
    </view>
