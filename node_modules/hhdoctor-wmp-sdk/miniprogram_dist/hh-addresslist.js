...
Component({
  ...
  methods: {
    ...
    _showDeleteMenu: function _showDeleteMenu(e) {
    ...
    _deleteAddress: function _deleteAddress(id) {
      if (!this.data._request.userToken) {
        return;
      }
      var url = this._getHost().wmpHost + 'address/deleteAddress?userToken=' + this.data._request.userToken + '&id=' + id;
      wx.request({
        url: url,
        data: {},
        method: 'POST',
    ...
    _getAddressList: function _getAddressList() {
      ...
      var url = this._getHost().wmpHost + 'address/listP?userToken=' + this.data._request.userToken;
      wx.request({
        url: url,
        data: {},
        method: 'POST',
