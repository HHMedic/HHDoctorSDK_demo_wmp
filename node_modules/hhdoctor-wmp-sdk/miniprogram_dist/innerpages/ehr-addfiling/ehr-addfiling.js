...
Page({
    ...
    data: {
        ...
        },
        {
            isCheck: false,
            title: '提供病理切片',
            texts: ['病理切片', ' 1、请将病理切片包装好并快递给我司', ' 2、我司完成切片扫描及档案关联后，会把切片寄回给您', ' 地址：北京市东城区东直门来福士大厦7层701室', ' 收件人：田建浩 15028281602']
        }
        ],
        memberUuid: "",
        nickname: "",
    ...
    getUploadImg: function (chooseImages, index) {
        ...
        var upload_task = wx.uploadFile({
            url: `${apis.getUploadUrl()}?sdkProductId=${_options && _options.sdkProductId}&userToken=${_options && _options.userToken}`,
